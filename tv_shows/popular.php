...
print_r($_POST);
$dataGenres = file_get_contents("https://api.themoviedb.org/3/genre/tv/list?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US");
...
if (empty($_GET['page']) && empty($_POST['sort_by']) && empty($_GET['sort_by']) && empty($_POST['start']) && empty($_POST['end']) && empty($_POST['genres']) && empty($_GET['genres']) && empty($_POST['year']) && empty($_GET ['year'])){
    ...
    $dataBySort = file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate");
...
if (isset($_GET['page']) && (empty($_POST['sort_by']) && empty($_GET['sort_by']) && empty($_POST['start']) && empty($_POST['end']) && empty($_GET['start']) && empty($_GET['end']) && empty($_POST['genres']) && empty($_GET ['genres']) && empty($_POST['year']) && empty($_GET ['year']))) {
    ...
    $data = file_get_contents("https://api.themoviedb.org/3/tv/popular?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&page=$pageNumber");
...
if ((isset($_POST['sort_by']) || isset($_GET['sort_by'])) && (empty($_POST['start']) && empty($_POST['end']) && empty($_GET['start']) && empty($_GET['end']) && empty($_POST['genres']) && empty($_GET['genres']) && empty($_POST['year']) && empty($_GET ['year']) )) {
    ...
    $dataBySort = file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=$sort_key&include_adult=false&include_video=false&page=$pageNumber&with_watch_monetization_types=flatrate");
    $popularMovieArr = json_decode($dataBySort);
    $popularMovieArrResult = $popularMovieArr->results;
}
...
//        $pageNumber = $_GET['page'];
//    }
//    $dataByDate = file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=$pageNumber&first_air_date.gte=$start&first_air_date.lte=$end&with_watch_monetization_types=flatrate");
...
if ((isset($_POST['start']) && isset($_POST['end']) && isset($_POST['sort_by']) && empty($_POST['genres']) && empty($_POST['year'])) || (isset($_GET['start']) && isset($_GET['end']) && isset($_GET['sort_by']) && empty($_GET['genres']) && empty($_GET ['year']))) {
    ...
    $dataByDateAndSort = file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=$sort_key&include_adult=false&include_video=false&page=$pageNumber&first_air_date.gte=$start&first_air_date.lte=$end&with_watch_monetization_types=flatrate");
...
if ((isset($_POST['year']) && isset($_POST['sort_by']) && empty($_POST['genres']) && empty($_POST['start']) && empty($_POST['end'])) || (isset($_GET['year']) && isset($_GET['sort_by']) && empty($_GET['genres']) && empty($_POST['start']) && empty($_POST['end']))) {
    ...
    $dataByDateAndSort = file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=$sort_key&include_adult=false&include_video=false&page=$pageNumber&first_air_date_year=$year&with_watch_monetization_types=flatrate");
...
if ((isset($_POST['genres']) && isset($_POST['sort_by']) || isset($_GET['genres']) && isset($_GET['sort_by'])) && (empty($_POST['start']) && empty($_POST['end']) && empty($_POST['year']) && empty($_GET['start']) && empty($_GET['end']) && empty($_GET['year']))) {
    if (isset($_POST['genres'])) {
        ...
        $sort_key = $_POST['sort_by'];
        $dataByGenres = file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=$sort_key&include_adult=false&include_video=false&page=1&with_genres=$genresId&with_watch_monetization_types=flatrate");
    } else {
        ...
        $sort_key = $_GET['sort_by'];
        $pageNumber = $_GET['page'];
        $dataByGenres = file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=$sort_key&include_adult=false&include_video=false&page=$pageNumber&with_genres=$genresId&with_watch_monetization_types=flatrate");
    }
...
if ((isset($_POST['sort_by']) && isset($_POST['genres']) && isset($_POST['year']) && empty($_POST['start']) && empty($_POST['end'])) || (empty($_GET['start']) && empty($_GET['end']) && isset($_GET['sort_by']) && isset($_GET['genres']) && isset($_GET['year']))) {
    ...
    $dataBySortAndGenreAndYear= file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=$sort_key&include_adult=false&include_video=false&page=$pageNumber&first_air_date_year=$year&with_genres=$genresId&with_watch_monetization_types=flatrate");
...
if ((isset($_POST['start']) && isset($_POST['end']) && isset($_POST['sort_by']) && isset($_POST['genres']) && isset($_POST['year'])) || (isset($_GET['start']) && isset($_GET['end']) && isset($_GET['sort_by']) && isset($_GET['genres']) && isset($_GET['year']))) {
    ...
    $dataByDateAndSortAndGenreAndYear= file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=$sort_key&include_adult=false&include_video=false&page=$pageNumber&first_air_date_year=$year&first_air_date.gte=$start&first_air_date.lte=$end&with_genres=$genresId&with_watch_monetization_types=flatrate");
...
if ((isset($_POST['start']) && isset($_POST['end']) && isset($_POST['sort_by']) && isset($_POST['genres']) && empty($_POST['year'])) || (isset($_GET['start']) && isset($_GET['end']) && isset($_GET['sort_by']) && isset($_GET['genres']) && empty($_GET['year']))) {
    ...
    $dataByDateAndSortAndGenre = file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=$sort_key&include_adult=false&include_video=false&page=$pageNumber&first_air_date.gte=$start&first_air_date.lte=$end&with_genres=$genresId&with_watch_monetization_types=flatrate");
...
if ((isset($_POST['start']) && isset($_POST['end']) && isset($_POST['sort_by']) && isset($_POST['year']) && empty($_POST['genres'])) || (isset($_GET['start']) && isset($_GET['end']) && isset($_GET['sort_by']) && isset($_GET['year']) && empty($_GET['genres']))) {
    ...
    $dataByDateAndSortAndGenre = file_get_contents("https://api.themoviedb.org/3/discover/tv?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&sort_by=$sort_key&include_adult=false&include_video=false&page=$pageNumber&first_air_date_year=$year&first_air_date.gte=$start&first_air_date.lte=$end&with_watch_monetization_types=flatrate");
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="fw-bolder my-4">Popular TV Shows</h3>
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <select class="form-select" name="sort_by" aria-label="Default select example">
                                    ...
                                    <option value="first_air_date.desc" <?php echo $sort_key === "first_air_date.desc" ? "selected" : " " ?>> Release Date Descending</option>
                                    <option value="first_air_date.asc" <?php echo $sort_key === "first_air_date.asc" ? "selected" : " " ?> >Release Date Ascending</option>
                        ...
                        <div class="mb-4" style="width: 19.5%">
                            ...
                            <div class="card h-100 rounded-3">
                                ...
                                <div class="card-body position-relative pt-4">
                                    ...
                                    <a href="<?php echo $url; ?>/tv_shows/tv_shows_detail.php?id=<?php echo $row->id; ?>" class="title text-decoration-none text-dark">
