...
$dataVideoResultAsc = $row->videos->results;
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="list-clip" role="tabpanel" aria-labelledby="list-clip-list">
                                ...
                                <?php } else { ?>
                                    ...
                                    <p class="alert alert-warning text-dark">There are no English clips added to <?php echo $row->original_name; ?> .</p>
                            ...
                            <div class="tab-pane fade" id="list-behind" role="tabpanel" aria-labelledby="list-behind-list">
                                ...
                                <?php } else { ?>
                                    ...
                                    <p class="alert alert-warning text-dark">There are no English behind the scenes added to <?php echo $row->original_name; ?> .</p>
                            ...
                            <div class="tab-pane fade" id="list-blooper" role="tabpanel" aria-labelledby="list-blooper-list">
                                ...
                                <?php } else { ?>
                                    ...
                                    <p class="alert alert-warning text-dark">There are no English bloopers added to <?php echo $row->original_name; ?> .</p>
                            ...
                            <div class="tab-pane fade" id="list-featurette" role="tabpanel" aria-labelledby="list-featurette-list">
                                ...
                                <?php } else { ?>
                                    ...
                                    <p class="alert alert-warning text-dark">There are no English Featurettes added to <?php echo $row->original_name; ?> .</p>
