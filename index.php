...
<!--        latest trailers start-->
        <div class="col-12 my-5">
            <div class="d-flex">
                <h3 class="me-3">Latest Trailers</h3>
                <ul class="nav nav-pills mb-3 border border-dark rounded-pill" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active rounded-pill" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#latestTrailerMovie" type="button" role="tab" aria-controls="latestTrailerMovie" aria-selected="true">On TV</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link rounded-pill" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#latestTrailerTV" type="button" role="tab" aria-controls="latestTrailerTV" aria-selected="false">In Theaters</button>
                    </li>
                </ul>
            </div>
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="latestTrailerMovie" role="tabpanel" aria-labelledby="pills-home-tab">
                    <div class="row on-theater card-no-wrap overflow-scroll">
                        <?php foreach ($popularTVShowsResult as $row) { ?>
                            <div class="mb-3" style="width: 15.5%">
                ...
                <div class="tab-pane fade" id="latestTrailerTV" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <div class="row on-theater card-no-wrap overflow-scroll">
                        <?php foreach ($nowPlayingMoviesResult as $row) { ?>
                            <div class="mb-3" style="width: 15.5%">
