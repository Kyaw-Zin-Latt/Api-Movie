...
$data = file_get_contents("https://api.themoviedb.org/3/movie/top_rated?api_key=30abe6e1b3cd32a7e8d4b5ee6b117400&language=en-US&page=1");
$topRatedMovies = json_decode($data);
$topRatedMoviesResult = $topRatedMovies->results;

//print_r($topRatedMoviesResult);
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-9">
            <div class="row">
                <?php foreach ($topRatedMoviesResult as $row) { ?>
